...
func _ready():
	...
	WorldSyncronizer.spawn_lapa(Vector3(17.8, 3.5, -12.8))
	WorldSyncronizer.spawn_lapa(Vector3(0, 2.9, -5.5))
	WorldSyncronizer.spawn_lapa(Vector3(26.8, 3.34, 1.9))
	
	WorldSyncronizer.spawn_timbo(Vector3(28.9, 2.9, -24.1))
	
	WorldSyncronizer.spawn_starfish(Vector3(49.7, 4.8, 1.7))
